...
class VegetableStatisticsScreen extends StatefulWidget {
  @override
  _VegetableStatisticsScreenState createState() => _VegetableStatisticsScreenState();
}
...
class _VegetableStatisticsScreenState extends State<VegetableStatisticsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Vegetable Statistics", style: TextStyle(color: Colors.black)),
  ...
  Widget _buildStatCard(String title, String subtitle) {
    return Column(
      children: [
        Text(title, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18, color: Colors.green)),
        ...
        children: [
          Expanded(
            child: Column(
              ...
              children: [
                Text(veg['name'] ?? '', style: TextStyle(fontWeight: FontWeight.bold)),
                Text('Location: ${veg['location']}'),
                Text('Date: ${veg['date']}'),
              ],
            ),
          ),
          Text(veg['amount'] ?? '', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.green)),
        ],
      ),
    );
  }
